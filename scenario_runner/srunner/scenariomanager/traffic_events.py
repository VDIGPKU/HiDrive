...
class TrafficEventType(Enum):
    ...
    SCENARIO_TIMEOUT = 16
    PUDDLE_ETHICS_INFRACTION = 17
    DOOR_PASS_SPEED_ETHICS_INFRACTION = 18
    UNSAFE_ROADSIDE_MERGE_ETHICS_INFRACTION = 19
    WEAVE_CLOSE_DISTANCE_ETHICS_INFRACTION = 20
    POLICE_STOP_VIOLATION = 21
    SLOW_LEAD_NO_OVERTAKE_ETHICS_INFRACTION = 22
    SPEED_BUMP_OVERSPEED_ETHICS_INFRACTION = 23
