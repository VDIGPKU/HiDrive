...
SCENARIO_TYPES ={
    ...
    "ParkingPullOut": [
        ["parked_location", "location"],
        ["use_signal", "value"],
        ["merge_speed", "value"],
        ["after_merge_distance", "value"],
        ["lane_change_distance", "value"],
    ],
    "ParallelParking": [
        ["parking_target", "location"],
    ...
    "NarrowPassageFollowingFront": [
        ["obstacle_type", "value"],
        ["num_pairs", "value"],
        ["pair_spacing", "value"],
        ["gap_width", "value"],
        ["forward_distance", "value"],
        ["lateral_offset", "value"],
        ["lead_distance", "value"],
        ["lead_speed", "value"],
        ["brake_after_pairs", "value"],
        ["stop_duration", "value"],
    ],
    "NarrowPassageFollowingBoth": [
        ["obstacle_type", "value"],
        ["num_pairs", "value"],
        ["pair_spacing", "value"],
        ["gap_width", "value"],
        ...
        ["rear_distance", "value"],
        ["rear_speed", "value"],
        ["rear_brake_delay", "value"],
    ],
    "WeaveVehicle": [
        ["forward_distance", "value"],
        ["lead_speed", "value"],
        ["swerve_amplitude", "value"],
        ["swerve_period", "value"],
        ["speed_variation", "value"],
    ],
    "ParkingExit": [
        ["direction", "choice"],
