...
IS_BIRD_VIEW = os.environ.get('BIRD_VIEW_MODE') == 'bird'
if IS_BENCH2DRIVE or IS_BIRD_VIEW:
    MAX_ALLOWED_RADIUS_SENSOR = 100.0  # for visualize / bird view
else:
            ...
            # These are the sensors spawned on the carla world
                ...
                if type_.startswith('sensor.camera'):
                    ...
                    if "Town10HD_Opt" in map_name:
                        bp.set_attribute('post_process_profile', 'Town10HD_Opt')
